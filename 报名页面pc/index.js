...
button.addEventListener("click",function(){
    ...
    confirm.addEventListener("click",function(){
        ...
        right.style.filter="blur(0)";
        Ajax({
            url: "https://join.xiyoumobile.com/signup/user/add",
            type: "post",
            data: "sid="+card3.children[2].value+"&name="+card3.children[4].value+"&clazz="+card3.children[6].value+"&sex="+card3.children[8].value,
            async:true,  //是否异步
        });
        for(var i=0;i<4;i++){
            input[i].value="";
...
function Ajax(object){
    ...
    if(object.type=="get"){
        ...
        xhr.setRequestHeader("Authorization","Basic eGl5b3UzZzp4aXlvdTNnZnoxNTUqKi8v");//身份验证
